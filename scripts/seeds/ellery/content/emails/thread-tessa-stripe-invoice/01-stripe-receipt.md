---
key: msg-tessa-stripe-receipt
model: EmailMessage
thread: !ref thread-tessa-stripe-invoice
user: !ref tessa
...
<tr>
  <td style="padding:24px;background-color:#ffffff;">
    <p style="font-size:20px;color:#1a1a1a;font-weight:bold;margin:0 0 8px 0;">$149.00</p>
    <p style="font-size:13px;color:#555;margin:0 0 20px 0;">Paid on April 17, 2026 &bull; Receipt #1482-9021</p>
    <table width="100%" cellpadding="8" cellspacing="0" style="border-collapse:collapse;font-size:13px;color:#1a1a1a;border:1px solid #e0e0e0;">
      ...
      <tr>
        <td style="border-bottom:1px solid #e0e0e0;padding:10px;">Revenue Intelligence Platform — Starter (monthly)</td>
        <td style="border-bottom:1px solid #e0e0e0;padding:10px;text-align:right;">$149.00</td>
      </tr>
      <tr style="background-color:#f9f9f9;">
        <td style="padding:10px;"><strong>Total</strong></td>
        <td style="padding:10px;text-align:right;"><strong>$149.00</strong></td>
      </tr>
    </table>
    <p style="font-size:12px;color:#888;margin:16px 0 0 0;">Questions? Contact support at support@stripe.com.</p>
  </td>
</tr>
<tr>
  <td style="background-color:#f6f6f6;padding:12px 24px;text-align:center;font-size:11px;color:#888;">
    Stripe, Inc. &bull; 354 Oyster Point Blvd, South San Francisco, CA &bull; <a href="#" style="color:#888;">View receipt online</a>
  </td>
</tr>
</table>
